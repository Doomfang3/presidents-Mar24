...
const getNames = presidentsArr => presidentsArr.map(currentPresident => currentPresident.name)
...
function getDemocraticPresidents(presidentsArr) {
  return presidentsArr.filter(currentPresident => {
...
function countYearsInOffice(presidentsArr) {
  return presidentsArr.reduce((accumulator, currentPresident) => {
...
function sortPresidentsByName(presidentsArr) {
  return presidentsArr.toSorted((a, b) => a.name.localeCompare(b.name))
}
